...
public class AnimatedTile extends BasicTile {
	...
	public void render(Screen screen, Level level, int x, int y, int displayWidth, int displayHeight) {
		screen.render(x, y, tileSheet, animationTileCoords[currentAnimationIndex][0], 
				animationTileCoords[currentAnimationIndex][1],
				Screen.MirrorDirection.NONE, displayWidth, displayHeight);
	}
}