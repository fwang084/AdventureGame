...
public class BasicTile extends Tile {
	 ...
	 * 
	 * @param row
	 *          row coordinate for tile in sprite sheet. NOTE: not pixel coordinate.
	 *          If tile is the 3rd, tile over, x should be 2 (since tiles are
	 *          numbered starting at 0)
	 * @param col
	 *          column
	 *           for tile in sprite sheet. (See note above)
	 * @param levelColour
	 *          color this tile will be represented by in level image.
	 */
	public BasicTile(SpriteSheet sheet, int row, int col, int levelColour) {
		this(sheet, Loc.asList(row, col), levelColour);
	}
