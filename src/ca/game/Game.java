...
public class Game extends Canvas implements Runnable {
	...
	public void init() {
		...
		SpriteSheet.wizardSheet.displayInfo();
		...
		level.setTileAt(3,  5,  Tile.VOID);
		level.setTileAt(7, 7, Tile.WHALE);
		level.addCoin(25, 25, 3);
		level.addCoin(150, 150, 10);
		
		

		player = new Player(level, 100, 100, 0, SpriteSheet.wizardSheet, 12, input,
				JOptionPane.showInputDialog(this, "Please enter a username"));
		level.addPlayer(player);
		level.addPopstar(800, 800);
		level.addWumpus(850, 850);
		level.addWumpus(1000, 400);
		level.addTower(100, 500);
	}
